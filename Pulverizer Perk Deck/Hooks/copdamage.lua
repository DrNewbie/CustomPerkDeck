...
function CopDamage:damage_melee(attack_data)
	...
	if is_ply and is_ply._pulverizer_damage_stack_t and _prec and attack_data and attack_data.damage then
	...
	if is_ply and is_ply._pulverizer_damage_stack_t and _prec and res and res.type == "death" then
